...
class AlarmSelectionActivity : ListActivity() {
    ...
    companion object {
        ...
        const val EXTRA_ACTION = "com.shmuly.sternbach.daveningtimesreminder.deskclock.EXTRA_ACTION"
        const val EXTRA_ALARMS = "com.shmuly.sternbach.daveningtimesreminder.deskclock.EXTRA_ALARMS"
    }
}